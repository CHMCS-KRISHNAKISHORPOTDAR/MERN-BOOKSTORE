...
const BookDetailPage = () => {
  ...
  const handlesave = async () => {
    if (!book.title.trim() || !book.author.trim() || !book.publishYear.trim()) {
  ...
  return (
    <div className='min-h-scren bg-base-200'>
      <div className='container mx-auto px-4 py-8'>
        <div className='max-w-2x1 mx-auto'>
          ...
          <div className='card bg-base-100 shadow-1g'>
            <div className='card-body'>
              ...
              <div className='form-control mb-6'>
                ...
                <input type="text" placeholder='Book author' className='input input-bordered'
              ...
              <div className='form-control mb-6'>
                ...
                <input type="number" placeholder='Year' className='input input-bordered'
                  value={book.publishYear} onChange={(e) => setBook({ ...book, publishYear: e.target.value })
                  } />
              </div>
